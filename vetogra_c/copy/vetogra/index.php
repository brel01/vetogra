				...
				<div id="rev_slider_34_1" class="rev_slider" data-version="5.0.7">
					<ul>
						...
						<li data-index="rs-129"  >
				          ...
				          <center>
				            <a class="btn-text"  href="./dashboard">DASHBOARD</a>
				            <a class="btn-text" href="./logout">LOGOUT</a>
				          </center>
				        <?php }else{ ?>
				          <center>
					...
					<div class="col-md-4 col-sm-12">
						<div class="single_top__block text-center" style="background:#0c192a">
							...
							<div class="single_text__block">
								...
								<p>
									We dont't mine ETHEREUM. With an active ETH VETOTASK, you can generate and convert ETH VetoGases to ETH
								</p>
							</div>
						</div>
					</div>
                ...
                <div class="tl-body" >
                  <div class="tl-entry" >
                    ...
                    <div class="tl-content" style="background:#0c192a">
                      <h4 class="tl-tile text-primary" style="color:#daa106">Affiliate & Non-Affilate</h4>
                      <p style="color:#ffffff"> Consectetur adipisicing elit. Error, accusantium debitis voluptatem dolore excepturi ducimus fugiat nulla perspiciatis quo ipsum non eligendi nisi veniam maxime in quas atque omnis cumque! </p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="tl-item alt">
                <div class="tl-body">
                  <div class="tl-entry">
                    ...
                    <div class="tl-content" style="background:#0c192a">
                      <h4 class="tl-tile text-danger" style="color:#daa106">Parallel System</h4>
                      <p style="color:#ffffff"> Ullam, commodi, modi, impedit nostrum odio sit odit necessitatibus accusantium enim voluptates culpa cupiditate cum pariatur a recusandae tenetur aspernatur at beatae. </p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="tl-body">
                  <div class="tl-entry">
                    ...
                    <div class="tl-content" style="background:#0c192a">
                      ...
                      <p style="color:#ffffff"> Incidunt, molestias odio soluta nihil accusantium sit nostrum doloremque. Recusandae, ullam, odio consequatur facere totam reiciendis similique dicta explicabo! </p>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <section class="services-section__block pt-90 pb-80 ptb-xs-60" style="background:#12253f">
        ...
        <center><h2><span> FAQ</span></h2></center>
          ...
          <!-- <i class="fa fa-circle"></i> -->
                                ...
                                <!-- <strong>Job Description:</strong> -->
                  								...
                  								<li>While starting a veto task it is beign set to generate a certain amount of ETHEREUM within the range of (0.2ETH - 10ETH).</li>
																	...
																	<ul>
																		...
																		<li>
																			To start a parallel EHT VETO TASK, ETH VETO GAS(50% of the ETH VETO TASK) is to be sent to the ETH VETO TASK deposite address.
																		</li>
																	</ul>
                        ...
                        <div class="accordion-content animated" data-content>
                            <div class="content-inner">
                                <!-- <strong>Job Description:</strong> -->
              								...
              								<ul><li>ETH Veto Gas= 50% of ETH Veto Task </li>
															</ul>
															<strong>80% of the ETH VETO GAS used to start an ETH VETO TASK goes to the user upline while 20%
																circulates within the Veto Environment</strong>
                    ...
                    <div class="accordion" data-accordion>
                        <div class="accordion-title" data-control>
                            <p>WHAT IS A RUNNING ETH VETOTASK</p>
                        </div>
                        <div class="accordion-content animated" data-content>
                           <div class="content-inner">
                                <!-- <strong>Job Description:</strong> -->
                    ...
                    <div class="accordion" data-accordion>
                        <div class="accordion-title" data-control>
                            <p>WHAT IS AN ARCHIVED ETH VETO TASK</p>
                        </div>
                        <div class="accordion-content animated" data-content>
                            <div class="content-inner">
                                <!-- <strong>Job Description:</strong> -->
			...
			<div class="container" style="background:#12253f">
				...
				<div class="row">
					<div class="col-lg-3 col-sm-6 disp_table text-center mb-sm-30 mb-xs-30">
						<div class="process-icon icon_down_new">
							<div class="icon-container">
								<a href="#"> <span class="icon_bigger"> <i class="ion-social-bitcoin"></i> </span> </a>
							</div>
					...
					<div class="col-lg-3 col-sm-6 disp_table text-center mb-sm-30 mb-xs-30">
						<div class="process-icon icon_down_new">
							<div class="icon-container">
								<a href="#"> <span class="icon_bigger"> <i class="io-social-bitcoin"></i> </span> </a>
							</div>
							<div class="text_-work">
