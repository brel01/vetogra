...
<div class="wrapper">
                  ...
                  <fieldset>
                    <div class="form-group">
                      ...
                      <div class="ui-input-group">
                        <input type="text" required class="form-control" id="referrer" placeholder="REFERRER USERNAME"
                        <?php
                        if(isset($_GET)){
                          if(isset($_GET['ref'])){
                    ...
                    <input type="hidden" name="user_check" id="user_check" value="yes">
  ...
  <!-- CONTINUE -->
  <div id="continue" class="ptb ptb-xs-60 page-signin">
    <div class="container">
      <div class="row">
        <div class="main-body">
          <div class="body-inner">
              ...
              <div class="card-content">
                ...
                <form class="form-horizontal ng-pristine ng-valid">
                  <fieldset>
                    <div class="form-group">
                      <div class="ui-input-group">
                        <input type="text" id="r_referrer" required  class="form-control">
                        <span class="input-bar"></span>
                        <label>ENTER REFERRER USERNAME</label>
                      </div>
                    </div>
                  </fieldset>
                </form>
              </div>
              <center><a class="btn-text" href="#" onClick="r_user_register()" style="margin-bottom:20px">Continue without referrer</a></center>
            </div>
          </div>
        </div>
      </div>
...
function r_user_register(){
  $("#continue").hide();
  $("#login").show();
  var referrer = $("#r_referrer").val();
  var uname = $("#uname").val();
  if(uname.length > 0){
    $("#uname_error").hide();
    var fname = $("#fname").val();
